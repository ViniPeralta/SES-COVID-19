...
public class InterfaceB3_CadRemAtendente extends javax.swing.JFrame {

    public InterfaceB3_CadRemAtendente() {
        initComponents();
        ...
        MyHeaderRender.setHorizontalAlignment(JLabel.CENTER);
        AtendenteTable.getTableHeader().getColumnModel().getColumn(0).setHeaderRenderer(MyHeaderRender);
        AtendenteTable.getTableHeader().getColumnModel().getColumn(1).setHeaderRenderer(MyHeaderRender);
        AtendenteTable.getTableHeader().getColumnModel().getColumn(2).setHeaderRenderer(MyHeaderRender);
        DefaultTableCellRenderer centerRenderer = new DefaultTableCellRenderer();
        centerRenderer.setHorizontalAlignment(JLabel.CENTER);
        AtendenteTable.getColumnModel().getColumn(0).setCellRenderer(centerRenderer);
        AtendenteTable.getColumnModel().getColumn(1).setCellRenderer(centerRenderer);
        AtendenteTable.getColumnModel().getColumn(2).setCellRenderer(centerRenderer);
    ...
    private void initComponents() {
        ...
        AtendenteTable = new javax.swing.JTable();
        ...
        Atendente2.setFont(new java.awt.Font("Inter SemiBold", 0, 30)); // NOI18N
        Atendente2.setForeground(new java.awt.Color(0, 0, 0));
        Atendente2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        Atendente2.setText("Atendente");
        remover.add(Atendente2, new org.netbeans.lib.awtextra.AbsoluteConstraints(308, 3, 324, 46));
        ...
        AtendenteTable.setBackground(new java.awt.Color(255, 255, 255));
        AtendenteTable.setFont(new java.awt.Font("Amazon Ember", 0, 15)); // NOI18N
        AtendenteTable.setForeground(new java.awt.Color(0, 0, 0));
        AtendenteTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        AtendenteTable.setGridColor(new java.awt.Color(0, 0, 0));
        AtendenteTable.setRowHeight(25);
        AtendenteTable.setShowGrid(true);
        AtendenteTable.getTableHeader().setReorderingAllowed(false);
        scrollPane.setViewportView(AtendenteTable);
        ...
        remover.add(btnDeletar, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 330, -1, -1));
        ...
        remover.add(btnDeletarClicado, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 330, -1, -1));
        ...
        administrador.setText("Atendente");
        ...
        cadastrar.add(btnCadastrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 300, 267, -1));
        ...
        cadastrar.add(btnCadastrarClicado, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 300, 267, -1));
    ...
    private void btnDeletarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDeletarMouseClicked
        ...
        if (AtendenteTable.getSelectedRow() == -1) {
            JOptionPane.showMessageDialog(null, "Selecione um Administrador!", "Seleção Vazia", JOptionPane.ERROR_MESSAGE);
        } else {
            String user = AtendenteTable.getValueAt(AtendenteTable.getSelectedRow(), 0).toString();
            String name = AtendenteTable.getValueAt(AtendenteTable.getSelectedRow(), 1).toString();
            String phone = AtendenteTable.getValueAt(AtendenteTable.getSelectedRow(), 2).toString();
            ...
            if (x == JOptionPane.YES_OPTION) {
                ...
                deleta.deleteAtendente(novo);
                JOptionPane.showMessageDialog(null, "Atendente deletado!", "Succeso", JOptionPane.INFORMATION_MESSAGE);
            } else {
    ...
    public void cadastraAtendente() {
        ...
        if (user.equals("") || password.equals("") || name.equals("") || phone.equals("")) {
            ...
            Usuario atend = new Usuario(user, password, name, phone, cargo);
            atend.setUsuario(user);
            atend.setSenha(password);
            atend.setNome(name);
            atend.setFone(phone);
            atend.setCargo(cargo);

            UsuarioDAO cria = new UsuarioDAO();
            cria.createAtendente(atend);
        }
        txtUsuario.setText("");
        txtSenha.setText("");
        txtNome.setText("");
    ...
    public void readLista() {
        DefaultTableModel modelo = (DefaultTableModel) AtendenteTable.getModel();
        modelo.setRowCount(0);

        UsuarioDAO novo = new UsuarioDAO();
        for (Usuario p : novo.listAtendente()) {
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(InterfaceB3_CadRemAtendente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfaceB3_CadRemAtendente().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable AtendenteTable;
